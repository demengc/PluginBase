 ...
 * using PluginBase's utilities. All error messages can be customized through locale files using the
 * standard "commands.*" keys.
 *
 * <p><b>Localization Keys and Placeholders:</b></p>
 * <ul>
 *   <li><b>commands.invalid-player</b> - {0}: player input</li>
 *   <li><b>commands.invalid-world</b> - {0}: world input</li>
 *   <li><b>commands.missing-location-parameter</b> - {0}: axis name</li>
 *   <li><b>commands.sender-not-console</b> - No placeholders</li>
 *   <li><b>commands.sender-not-player</b> - No placeholders</li>
 *   <li><b>commands.malformed-entity-selector</b> - {0}: input, {1}: error message</li>
 *   <li><b>commands.non-player-entities</b> - {0}: selector input</li>
 *   <li><b>commands.more-than-one-entity</b> - No placeholders</li>
 *   <li><b>commands.empty-entity-selector</b> - No placeholders</li>
 *   <li><b>commands.enum-not-found</b> - {0}: invalid input</li>
 *   <li><b>commands.expected-literal</b> - {0}: expected node name, {1}: actual input</li>
 *   <li><b>commands.input-parse.invalid-escape</b> - No placeholders</li>
 *   <li><b>commands.input-parse.unclosed-quote</b> - No placeholders</li>
 *   <li><b>commands.input-parse.expected-whitespace</b> - No placeholders</li>
 *   <li><b>commands.invalid-list-size.too-small</b> - {0}: minimum size, {1}: parameter name</li>
 *   <li><b>commands.invalid-list-size.too-large</b> - {0}: maximum size, {1}: parameter name</li>
 *   <li><b>commands.invalid-string-size.too-small</b> - {0}: parameter name, {1}: minimum length</li>
 *   <li><b>commands.invalid-string-size.too-large</b> - {0}: parameter name, {1}: maximum length</li>
 *   <li><b>commands.invalid-boolean</b> - {0}: invalid input</li>
 *   <li><b>commands.invalid-decimal</b> - {0}: invalid input</li>
 *   <li><b>commands.invalid-integer</b> - {0}: invalid input</li>
 *   <li><b>commands.invalid-uuid</b> - {0}: invalid input</li>
 *   <li><b>commands.missing-argument</b> - {0}: parameter name, {1}: command usage</li>
 *   <li><b>commands.no-permission</b> - No placeholders</li>
 *   <li><b>commands.number-not-in-range.too-small</b> - {0}: parameter name, {1}: input value, {2}: minimum</li>
 *   <li><b>commands.number-not-in-range.too-large</b> - {0}: parameter name, {1}: input value, {2}: maximum</li>
 *   <li><b>commands.invalid-help-page.single</b> - {0}: requested page number</li>
...
public class BaseExceptionHandler extends BukkitExceptionHandler {
  ...
  public void onInvalidWorld(InvalidWorldException e, BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.invalid-world",
        "&cInvalid world: &e{0}&c.",
        e.input()));
  }

  @Override
  public void onInvalidWorld(MissingLocationParameterException e,
  ...
  @Override
  public void onMalformedEntitySelector(MalformedEntitySelectorException e,
      BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
  ...
  public void onEmptyEntitySelector(EmptyEntitySelectorException e, BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.empty-entity-selector",
        "&cNo entities were found."));
  }
  ...
  @Override
  public void onExpectedLiteral(@NotNull ExpectedLiteralException e,
  ...
  @Override
  public void onInvalidListSize(@NotNull InvalidListSizeException e,
      @NotNull BukkitCommandActor actor, @NotNull ParameterNode<BukkitCommandActor, ?> parameter) {
  ...
  @Override
  public void onInvalidStringSize(@NotNull InvalidStringSizeException e,
      @NotNull BukkitCommandActor actor, @NotNull ParameterNode<BukkitCommandActor, ?> parameter) {
  ...
  @Override
  public void onInvalidBoolean(@NotNull InvalidBooleanException e,
      @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
  ...
  @Override
  public void onInvalidDecimal(@NotNull InvalidDecimalException e,
      @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.invalid-decimal",
        "&cInvalid number: &e{0}&c.",
        e.input()));
  }

  @Override
  public void onInvalidInteger(@NotNull InvalidIntegerException e,
      @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.invalid-integer",
        "&cInvalid integer: &e{0}&c.",
        e.input()));
  }
  ...
  public void onInvalidUUID(@NotNull InvalidUUIDException e, @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.invalid-uuid",
        "&cInvalid UUID: &e{0}&c.",
        e.input()));
  }

  @Override
  public void onMissingArgument(@NotNull MissingArgumentException e,
      @NotNull BukkitCommandActor actor, @NotNull ParameterNode<BukkitCommandActor, ?> parameter) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
  ...
  @Override
  public void onNumberNotInRange(@NotNull NumberNotInRangeException e,
      @NotNull BukkitCommandActor actor,
  ...
  @Override
  public void onInvalidHelpPage(@NotNull InvalidHelpPageException e,
      @NotNull BukkitCommandActor actor) {
  ...
  @Override
  public void onUnknownCommand(@NotNull UnknownCommandException e,
      @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
        "commands.unknown-command",
        "&cUnknown command: &e{0}&c.",
        e.input()));
  }

  @Override
  public void onValueNotAllowed(@NotNull ValueNotAllowedException e,
      @NotNull BukkitCommandActor actor) {
  ...
  @Override
  public void onCommandInvocation(@NotNull CommandInvocationException e,
      @NotNull BukkitCommandActor actor) {
    Text.tell(actor.sender(), getLocalizedError(
        actor,
  ...
  @Override
  public void onUnknownParameter(@NotNull UnknownParameterException e,
      @NotNull BukkitCommandActor actor) {
    if (e.shorthand()) {
      Text.tell(actor.sender(), getLocalizedError(
          actor,
