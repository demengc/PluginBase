...
See [Getting Started](getting-started/getting-started.md) for installation instructions and your first plugin. This documentation focuses on example-driven guides for core features and optional modules.
