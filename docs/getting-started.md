...
the [releases page](https://github.com/demengc/PluginBase/releases).

## Shading and Relocation

To avoid dependency conflicts with other plugins, you should shade and relocate PluginBase into your
plugin JAR.
...
**Important:** Replace `com.example.myplugin.lib.pluginbase` with your own package structure to
avoid conflicts.

### Preserving Parameter Names (Optional)

By default, Java does not preserve method parameter names. To enable features such as automatic
command metadata, you should compile your project with the `-parameters` flag.
